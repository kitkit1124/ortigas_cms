		...
		<div class="card">
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('areas.countries.add', 'return')): ?>
						<a href="<?php echo site_url('areas/countries/form/add')?>" data-toggle="modal" data-target="#modal" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
				...
				<table class="table table-striped table-bordered table-hover dt-responsive" id="datatables">
					<thead>
						<tr>
							...
							<th class="min-tablet"><?php echo lang('index_code2'); ?></th>
							<th class="min-tablet"><?php echo lang('index_code3'); ?></th>
							<th class="min-desktop"><?php echo lang('index_continent'); ?></th>
