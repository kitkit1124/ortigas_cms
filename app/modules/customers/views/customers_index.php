<section id="roles">
	<div class="container-fluid">
		<div class="card">
			...
			<th class="min-desktop"><?php echo lang('index_id_type'); ?></th>
			<th class="min-desktop"><?php echo lang('index_id_details'); ?></th>
			<th class="min-desktop"><?php echo lang('index_mailing_country'); ?></th>
			<th class="min-desktop"><?php echo lang('index_mailing_house_no'); ?></th>
			<th class="min-desktop"><?php echo lang('index_mailing_street'); ?></th>
			<th class="min-desktop"><?php echo lang('index_mailing_city'); ?></th>
			<th class="min-desktop"><?php echo lang('index_mailing_brgy'); ?></th>
			<th class="min-desktop"><?php echo lang('index_mailing_zip_code'); ?></th>
			<th class="min-desktop"><?php echo lang('index_billing_country'); ?></th>
			<th class="min-desktop"><?php echo lang('index_billing_house_no'); ?></th>
			<th class="min-desktop"><?php echo lang('index_billing_street'); ?></th>
			<th class="min-desktop"><?php echo lang('index_billing_city'); ?></th>
			<th class="min-desktop"><?php echo lang('index_billing_brgy'); ?></th>
			<th class="min-desktop"><?php echo lang('index_billing_zip_code'); ?></th>
