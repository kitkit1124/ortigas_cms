 ...
 */
class Migration_Edit_property_categories extends CI_Migration 
{
	...
	{
		$fields = array(
			'category_metatag_id' => array('type' => 'INT', 'unsigned' => TRUE, 'null' => FALSE),
		);
		
		$this->dbforge->add_column($this->_table, $fields);
		$this->db->query('ALTER TABLE ' . $this->_table . ' ADD INDEX `category_metatag_id` (`category_metatag_id`)');
	}
