...
class Migration_Create_posts extends CI_Migration 
{
	...
	public function up()
	{
		...
		$data = array(
			array('post_title'  => 'Sample Post #1', 'post_slug' => 'sample-post-1', 'post_content' => 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Sed posuere consectetur est at lobortis. Cras mattis consectetur purus sit amet fermentum.', 'post_posted_on' => date('Y-m-d H:i:s'), 'post_status' => 'Posted', 'post_created_by' => 1),
			array('post_title'  => 'Sample Post #2', 'post_slug' => 'sample-post-2', 'post_content' => 'Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.', 'post_posted_on' => date('Y-m-d H:i:s'), 'post_status' => 'Posted', 'post_created_by' => 1),
			array('post_title'  => 'Sample Post #3', 'post_slug' => 'sample-post-3', 'post_content' => 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Aenean lacinia bibendum nulla sed consectetur. Etiam porta sem malesuada magna mollis euismod. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.', 'post_posted_on' => date('Y-m-d H:i:s'), 'post_status' => 'Posted', 'post_created_by' => 1),
		);
