...
class Migration_Create_partials extends CI_Migration 
{
	...
	public function up()
	{
		...
		$data = array(
			...
			array('partial_title'  => 'Career - Thank You', 'partial_content' => '<h1>Thank you for your interest.</h1><p>Our Human Resouces personnel will be in touch with you soon.</p>', 'partial_status' => 'Posted', 'partial_created_by' => 1),
			array('partial_title'  => 'Inquire - Thank You', 'partial_content' => '<h1>Thank you for your interest.</h1><p>Our Human Resouces personnel will be in touch with you soon.</p>', 'partial_status' => 'Posted', 'partial_created_by' => 1),
			array('partial_title'  => 'Inquire - Thank You', 'partial_content' => '<h1>Thank you for your interest.</h1><p>Our Human Resouces personnel will be in touch with you soon.</p>', 'partial_status' => 'Posted', 'partial_created_by' => 1),
