		...
		<div class="card">
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('website.partials.add', 'return')): ?>
						<a href="<?php echo site_url('website/partials/form/add')?>" class="btn btn-sm btn-success btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
				...
				<table class="table table-striped table-bordered table-hover dt-responsive" id="datatables">
					<thead>
						<tr>
							...
							<th class="min-desktop"><?php echo lang('index_title'); ?></th>
