$(function() {
	...
	$('#submit').click(function(e){
		...
		$.post(ajax_url, {
			reservation_reference_no: $('#reservation_reference_no').val(),
			reservation_project: $('#reservation_project').val(),
			reservation_property_specialist: $('#reservation_property_specialist').val(),
			reservation_sellers_group: $('#reservation_sellers_group').val(),
			reservation_unit_details: $('#reservation_unit_details').val(),
