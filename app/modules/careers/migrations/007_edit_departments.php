 ...
 */
class Migration_Edit_departments extends CI_Migration 
{
	...
	{
		$fields = array(
			'department_slug' => array('type' => 'VARCHAR', 'after' => 'department_name', 'constraint' => 255, 'null' => TRUE),
		);	
	...
	{
		$this->dbforge->drop_column($this->_table, 'department_slug');
	}
}