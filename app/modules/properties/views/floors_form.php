...
<div class="modal-body">
	<div class="form">
		...
		<div class="form-group">
			...
			<p class="note <?php echo isset($record->floor_image) ? 'hide' : ''; ?>"><i style="float: left;margin-left: 6px;">Recommended file type JPEG | PNG</i> <i style="float: right; margin-right: 6px;"> Max file size: 2.0 Mb</i><span style="clear: both;"></span></p>
