		...
		"aoColumnDefs": [
			...
			},
			{
				...
				"mRender": function (data, type, full) {
					return '<a href="categories/form/edit/'+full[0]+'" data-toggle="modal" data-target="#modal-lg" tooltip-toggle="tooltip" data-placement="top" title="Edit">' + data + '</a>';
				},
			},
			// {
			// 	"aTargets": [6],
			...
			// },
			{
				...
				"bSortable": false,
				"mRender": function (data, type, full) {
					html = '<a href="categories/form/view/'+full[0]+'" data-toggle="modal" data-target="#modal-lg" tooltip-toggle="tooltip" data-placement="top" title="View" class="btn btn-sm btn-success"><span class="fa fa-eye"></span></a> ';
					html += '<a href="categories/form/edit/'+full[0]+'" data-toggle="modal" data-target="#modal-lg" tooltip-toggle="tooltip" data-placement="top" title="Edit" class="btn btn-sm btn-warning"><span class="fa fa-pencil"></span></a> ';
