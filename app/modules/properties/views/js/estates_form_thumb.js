...
$(function() {
	...
	myDropzone.on("success", function(file, response) {
		...
		if (response.status == 'failed') {
			...
			$('#estate_thumb').val(response.image);
			$('#estate_active_thumb').attr('src', asset_url + response.image);
	...
	$('#image_sizes, #thumbnails').on("click", ".btn-image", function() {
		...
		$('#estate_thumb').val(image);
		$('#estate_active_thumb').attr('src', asset_url + image);
