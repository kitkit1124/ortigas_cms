...
$(function() {
	...
	myDropzone.on("success", function(file, response) {
		...
		if (img.status == 'failed') {
			...
			$('#location_image').val(img.image);
			$('#location_active_image').attr('src', asset_url + img.image);
			$('.dz-image, .dz-preview').remove();
			$('.dz-message').show();
	...
	$("#location_active_image").click(function(){
	...
	$('#image_sizes, #thumbnails').on("click", ".btn-image", function() {
		...
		$('#location_active_image').attr('src', asset_url + image);
