		...
		<div class="card">
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('properties.units.add', 'return')): ?>
						<a href="<?php echo site_url('properties/units/form/add')?>" data-toggle="modal" data-target="#modal-lg" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
				...
				<table class="table table-striped table-bordered table-hover dt-responsive" id="datatables">
					<thead>
						<tr>
							...
							<th class="min-desktop"><?php echo lang('index_floor_id'); ?></th>
							<th class="min-desktop"><?php echo lang('index_number'); ?></th>
							<th class="min-desktop"><?php echo lang('index_room_type_id'); ?></th>
							<th class="none"><?php echo lang('index_size'); ?></th>
							<th class="none"><?php echo lang('index_price'); ?></th>
							<th class="none"><?php echo lang('index_downpayment'); ?></th>
