			...
			<div class="card-close">
				<div class="card-buttons">
					<?php if ($this->acl->restrict('properties.room_types.add', 'return')): ?>
						<a href="<?php echo site_url('properties/room_types/form/add')?>" data-toggle="modal" data-target="#modal-lg" class="btn btn-sm btn-primary btn-add" id="btn_add"><span class="fa fa-plus"></span> <?php echo lang('button_add')?></a>
					<?php endif; ?>
				</div>
			</div>
