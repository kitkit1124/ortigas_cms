...
class Migration_Edit_properties_01 extends CI_Migration 
{
	...
	{
		$fields = array(
			'property_thumb' => array('type' => 'VARCHAR', 'constraint' => 255, 'null' => TRUE),
			'property_alt_thumb' => array('type' => 'VARCHAR', 'constraint' => 255, 'null' => TRUE),
		);	
	...
	{
		$this->dbforge->drop_column($this->_table, 'property_thumb');
		$this->dbforge->drop_column($this->_table, 'property_alt_thumb');
	}
}