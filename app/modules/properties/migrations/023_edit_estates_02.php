 ...
 */
class Migration_Edit_estates_02 extends CI_Migration 
{
	...
	{
		$fields = array(
			'estate_order' => array('type' => 'TINYINT', 'constraint' => 3, 'unsigned' => TRUE, 'null' => FALSE, 'default' => 99),
		);
	...
	{
		$this->dbforge->drop_column($this->_table, 'estate_order');
	}
}