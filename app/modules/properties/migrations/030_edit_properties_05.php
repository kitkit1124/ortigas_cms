 ...
 */
class Migration_Edit_properties_05 extends CI_Migration 
{
	...
	{
		$fields = array(
			'property_page_id' => array('type' => 'INT', 'constraint' => 10, 'null' => TRUE),
		);
	...
	{
		$this->dbforge->drop_column($this->_table, 'property_page_id');
	}
}